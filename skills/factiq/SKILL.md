...
| `disclosure_profile` | Direct lookup by the first `company_filter` ticker, the first ticker resolved from `company_name`, or `query`; not text or quarter search; other filters, detail, and limit are ignored |
